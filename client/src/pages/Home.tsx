    ...
    <div className={`app-shell ${darkMode ? "dark-mode" : ""}`}>
      <aside className="sidebar">
        <div className="brand-lockup">
          <div className="brand-mark-wrap"><img src="/manus-storage/pactline-mark_b9afa972.png" alt="Pactline mark" /></div>
